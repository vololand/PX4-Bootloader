...
/****************************************************************************
 * TARGET_HW_MODALAI_VOXL2_IO
 ****************************************************************************/

#elif  defined(TARGET_HW_MODALAI_VOXL2_IO)
...
# define INTERFACE_USB                  1
# define INTERFACE_USART                1
# define USBDEVICESTRING                "PX4 BL ThePeach K1"
# define USBPRODUCTID                   0x0001
...
# define INTERFACE_USB                  1
# define INTERFACE_USART                1
# define USBDEVICESTRING                "PX4 BL ThePeach R1"
...
#elif  defined(TARGET_HW_NarinH7)

# define APP_LOAD_ADDRESS               0x08008000
# define BOOTLOADER_DELAY               5000
# define INTERFACE_USB                  1
# define INTERFACE_USART                1
# define USBDEVICESTRING                "NarinFC-H7 BL FMU v5X.x"
# define USBPRODUCTID                   0x0033
# define USBVENDORID                    0x3185
# define USBMFGSTRING                   "Auterion"
# define BOOT_DELAY_ADDRESS             0x00000200
